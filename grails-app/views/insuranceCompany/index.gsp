		...
		<div id="list-insuranceCompany" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="website" title="${message(code: 'insuranceCompany.website.label', default: 'Website')}" />
				...
				<g:each in="${insuranceCompanyInstanceList}" status="i" var="insuranceCompanyInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: insuranceCompanyInstance, field: "website")}</td>
			...
			<div class="pagination">
				<g:paginate total="${insuranceCompanyInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
